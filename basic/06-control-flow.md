...
**说明**：`if`、`elif`、`else` 后面都需要冒号，这是 Python 语法规定。
...
```python
score = 95
if score >= 90:      # 从最严格的条件开始
    print("优秀")
elif score >= 60:
    print("及格")
```

**说明**：Python 从上到下检查条件，遇到第一个成立的就停止。条件应该从严格到宽松排列。
...
```python
age = 18
if age = 18:  # SyntaxError: 赋值不能用在条件中
    print("成年")
```
