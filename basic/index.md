...
Python 基础教程，从零开始学习 Python 编程，涵盖语法、数据类型、函数、面向对象等核心内容。

## 学习路线

```
环境搭建 → 语法基础 → 数据类型 → 控制流 → 函数 → 模块与文件 → 异常处理 → 面向对象 → 标准库与工具
```
...
- **[Python 简介与环境搭建](01-intro.md)** - 安装配置、IDE 选择、Hello World
- **[基本语法](02-syntax-basics.md)** - 缩进、注释、变量命名规则
...
- **[字典](11-dict.md)** - 键值对、遍历、方法
- **[集合](12-set.md)** - 去重、集合运算

### 流程控制

- **[输入输出](05-input-output.md)** - input()、print()、格式化输出
- **[控制流](06-control-flow.md)** - if/elif/else、三元表达式
- **[循环](07-loops.md)** - for、while、break、continue
...
- **[面向对象基础](18-oop-basics.md)** - 类、对象、属性、方法
- **[面向对象进阶](19-oop-advanced.md)** - 继承、多态、封装、魔法方法
...
2. 每章配有练习题，务必动手实践
3. 遇到问题先查看对应章节的**易错点**
4. 完成基础部分后，再按目标学习**进阶**、**数据库**、**Web 框架**、**数据科学**或**爬虫**
:::

::: warning Python 版本
本教程基于 **Python 3.14**，部分语法在旧版本可能不支持。建议使用 Python 3.10+ 版本学习。
:::
